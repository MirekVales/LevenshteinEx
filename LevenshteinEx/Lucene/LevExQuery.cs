...
namespace Lucene.Net.Search
{
    ...
    /// <summary>Implements optimized fuzzy search query. The similarity measurement
    /// is based on the LevenshteinDFA (edit distance) algorithm.
    /// 
    /// 
    /// </summary>
    [Serializable]
    public class LevExQuery : MultiTermQuery
    {
        ...
        /// </summary>
        public LevExQuery(Term term, float minimumSimilarity, int prefixLength)
        {
            this.Term = term;
        ...
        public LevExQuery(Term term, float minimumSimilarity) : this(term, minimumSimilarity, defaultPrefixLength)
        {
        }

        /// <summary> Calls <see cref="FuzzyQuery(Index.Term, float)">FuzzyQuery(term, 0.5f, 0)</see>.</summary>
        public LevExQuery(Term term) : this(term, defaultMinSimilarity, defaultPrefixLength)
        {
        }
        ...
        {
            return new LevExTermEnum(reader, Term, minimumSimilarity, prefixLength);
        }
        ...
        public override bool Equals(System.Object obj)
        {
            ...
            if (GetType() != obj.GetType())
                return false;
            LevExQuery other = (LevExQuery)obj;
